...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CareCircle — Family care, coordinated" },
      ...
      { property: "og:title", content: "CareCircle — Family care, coordinated" },
      { property: "og:description", content: "A calm shared workspace for families coordinating care for the people they love." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "CareCircle — Family care, coordinated" },
