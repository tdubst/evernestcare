...
- Authenticated isolated-staging proof passed for commit `c1129a8f1b95138ed9b3d7d51be685c687a81295` on September 23, 2026. The proof covered owner and revoked-user authentication, read-only workspace hydration, durable care-note create/read/reload, Care Circle and Vault projections, closed RPC denial, 54 direct table mutation denials, unchanged workspace records, and sentinel integrity. Formal Backend, Security, and QA acceptance remains pending until this result is archived in the approved restricted evidence system and referenced by the launch packet.
